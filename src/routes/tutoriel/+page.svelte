...
<div class="max-w-4xl mx-auto space-y-6">
	...
	<div class="card">
		<div class="flex justify-between items-start">
			<div>
				<p class="card-title">Guide de démarrage</p>
				<p class="text-3xl font-semibold text-coffee-900">Budget Planner</p>
				<p class="text-stone-500 text-sm mt-3">
					6 étapes pour prendre en main votre budget. Suivez-les dans l'ordre pour bien démarrer.
				</p>
			</div>
			<div class="w-12 h-12 bg-sage/10 text-sage rounded-xl flex items-center justify-center">
		...
		<div class="flex items-center mt-6">
			{#each steps as step, i}
				{#if i > 0}
					<svg
						class="w-4 h-4 text-white/40 flex-shrink-0 mx-1"
						viewBox="0 0 24 24"
						fill="none"
						stroke="currentColor"
						stroke-width="2.5"
				...
				{/if}
				<span
					class="flex-1 text-center px-2 py-1.5 bg-white/15 rounded-full text-sm font-medium text-white/90"
					>{step.title}</span
				>
			{/each}
		</div>
		...
		<div class="space-y-3">
			{#each steps as step, i}
				<div class="bg-white rounded-xl shadow-sm overflow-hidden">
					...
					>
						<div
							class="w-10 h-10 bg-sage/10 rounded-lg flex items-center justify-center flex-shrink-0"
						>
						...
						<svg
							class="w-5 h-5 text-stone-400 flex-shrink-0 transition-transform duration-200 {expandedStep ===
							step.id
								? 'rotate-180'
								: ''}"
							viewBox="0 0 24 24"
							...
							<ul class="mt-4 space-y-3">
								{#each step.points as point}
									<li class="flex items-start gap-3 text-sm text-stone-600">
										<svg
											class="w-4 h-4 text-sage flex-shrink-0 mt-0.5"
											viewBox="0 0 24 24"
											fill="none"
											stroke="currentColor"
											stroke-width="2.5"
		...
		<div class="space-y-3">
			<div class="flex items-start gap-3">
				...
				<div>
					...
					<p class="text-sm text-stone-500">
						Notez vos dépenses chaque jour ou tous les 2-3 jours pour ne rien oublier.
					</p>
				</div>
			</div>
			<div class="flex items-start gap-3">
				...
				<div>
					...
					<p class="text-sm text-stone-500">
						Pas besoin d'être parfait au début — vos enveloppes budgétaires s'affineront avec le
						temps.
					</p>
				</div>
			</div>
			<div class="flex items-start gap-3">
				...
				<div>
					...
					<p class="text-sm text-stone-500">
						Clôturez votre période dès que vous êtes prêt pour repartir sur une base propre.
					</p>
				</div>
			</div>
			<div class="flex items-start gap-3">
				...
				<div>
					...
					<p class="text-sm text-stone-500">
						Un coup d'œil suffit pour savoir où vous en êtes — c'est votre meilleur allié au
						quotidien.
					</p>
				</div>
			</div>
